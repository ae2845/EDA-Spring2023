...
EPAair_O3_NC2018_subset <- select(EPAair_O3_NC2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)

EPAair_O3_NC2019_subset <- select(EPAair_O3_NC2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)

EPAair_PM25_NC2018_subset <- select(EPAair_PM25_NC2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)

EPAair_PM25_NC2019_subset <- select(EPAair_PM25_NC2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)

#5
# Converting factor variable into character variable for both datasets first.
...
#Replacing current values with "PM2.5"; I couldn't get the code to accept both original character values at the same time, so I had to use an inelegant solution with longer code.
EPAair_PM25_NC2018_subset$AQS_PARAMETER_DESC[EPAair_PM25_NC2018_subset$AQS_PARAMETER_DESC == "Acceptable PM2.5 AQI & Speciation Mass"] <- "PM2.5"
EPAair_PM25_NC2018_subset$AQS_PARAMETER_DESC[EPAair_PM25_NC2018_subset$AQS_PARAMETER_DESC == "PM2.5 - Local Conditions"] <- "PM2.5"

EPAair_PM25_NC2019_subset$AQS_PARAMETER_DESC[EPAair_PM25_NC2019_subset$AQS_PARAMETER_DESC == "Acceptable PM2.5 AQI & Speciation Mass"] <- "PM2.5"
EPAair_PM25_NC2019_subset$AQS_PARAMETER_DESC[EPAair_PM25_NC2019_subset$AQS_PARAMETER_DESC == "PM2.5 - Local Conditions"] <- "PM2.5"
