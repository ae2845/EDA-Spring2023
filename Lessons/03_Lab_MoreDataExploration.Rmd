...
matrix1[2:4, 1:3] # [row 2-4, column 1-3] But the output renumbers the row and column back to 1 (not the original row number). 
...
#Since the format is month-day-year we will use function mdy()? --Isn't it dmy?
